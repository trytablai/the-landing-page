        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqItems.map((item, index) => (
              ...
              >
                <AccordionTrigger className="px-6 py-4 text-white hover:text-primary hover:no-underline hover:bg-gray-800/50 text-base md:text-lg font-thinbold transition-colors duration-200">
